...
const routes = [
    ...
    { route: 'guides', name: 'guides', moduleId: 'guides/guides', nav: false, title: 'Guides', settings: { icon: guidesIcon } },
    { route: 'guides/content/1.1', name: 'guides', moduleId: 'guides/guides', nav: true, title: 'Guides', settings: { icon: guidesIcon } },
